...
# Warnock: 42.1% - Loeffler: 57.9% 

{: .center}
![WL Posterior](../images/ga_wl_posteriors.png)

# Ossoff: 39.4% - Perdue: 60.6% 
Dem vote share MAP: 49.4%
...
| ----------|------|--------------|
| Ossoff    | 49.3 | 45.9 - 52.8  |
| Perdue    | 50.7 | 47.2 - 54.1  |
| Warnock   | 49.5 | 46.4 - 52.6  |
| Loeffler  | 50.5 | 47.4 - 53.6  |
...
When pollsters produce multiple polls, only the most recent poll was used. This filter only applies to Trafalgar Group as they were the only one that did multiple polls. 
