...
{: .cap} *Examples of images taken from Kaggle and the Chars74k website*
...
{: .cap} *Training plot showing categorical cross entropy and percent correct on validation set*
...
{: .cap} *On the left is the original image, on the right are possible variations that the network can receive as input.*
