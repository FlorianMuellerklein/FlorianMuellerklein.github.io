...
{: .center}*Examples of images taken from Kaggle and the Chars74k website*{: .center}
...
{: .center}*On the left is the original image, on the right are possible variations that the network can receive as input.*{: .center}
